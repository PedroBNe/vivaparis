...
export default function CarouselHome({ width, height }: { width: number, height: number }) {
            ...
            <div className="w-full h-full p-1">
              <Card className="w-full h-full shadow-none">
                <CardContent className={`w-full h-full flex items-center justify-center p-6`}>
                  <Image src={post.image} alt={post.alt} width={width} height={height} className="w-full h-full rounded-xl" />
                </CardContent>
              </Card>
            </div>
          </CarouselItem>
