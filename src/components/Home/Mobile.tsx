...
export default function Mobile() {
  return(
    <div className="w-[100% - 80px] mx-auto h-auto flex justify-center flex-col items-center overflow-hidden">
      ...
      <div id="sobre" className="w-full h-[500px] flex justify-end flex-col items-center mt-[1050px]">
        <div className="h-full flex flex-col gap-10 justify-between items-center my-20">
          ...
          <div className="max-w-[500px] flex flex-col gap-7 justify-center items-center px-2">
            <h1 className="font-bold text-lg text-green-700">Quem sou eu ?</h1>
            <p className="text-black text-sm text-center">Texto sobre Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus in nesciunt nulla eveniet unde eius aliquam consequatur adipisci. Illum nam distinctio id perferendis accusantium eius fugit nisi, accusamus neque commodi.</p>
      ...
      <div className="relative rounded-b-[80px] w-full h-[180em] mt-8 flex flex-col items-center justify-between p-[80px] z-10 text-xl">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreRosa} alt="torre-rosa" width={110} height={110} className="absolute left-[-80px] bottom-8 rotate-[-15deg]" />
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreRoxa} alt="torre-roxa" width={110} height={110} className="absolute right-[-80px] bottom-8 rotate-[15deg]" />
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreAmarela} alt="torre-vermelha" width={110} height={110} className="absolute left-[-80px] bottom-8 rotate-[-15deg]" />
          <div data-aos="fade-right" data-aos-duration="900">
            <Image className="rounded-xl" src="https://ifpnews.com/wp-content/uploads/2018/02/Louvre-Museum-2-696x464.jpg" alt="museu-louvre" width={500} height={500} />
          </div>
          <div className="max-w-[500px] flex flex-col justify-center  items-center gap-4">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreBege} alt="torre-vermelha" width={110} height={110} className="absolute right-[-80px] bottom-8 rotate-[15deg]" />
          <div data-aos="fade-left" data-aos-duration="900">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreVerde} alt="torre-vermelha" width={110} height={110} className="absolute left-[-80px] bottom-8 rotate-[-15deg]" />
          <div data-aos="fade-right" data-aos-duration="900">
      ...
      <div className="relative rounded-b-[80px] w-full h-[200em] mt-12 flex flex-col items-center justify-between p-[80px] z-10 text-xl">
        <h2 className="absolute top-0 flex text-2xl text-green-700 font-semibold">
          <p
          data-aos="fade-right"
          data-aos-duration="900"
          >
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreVermelha} alt="torre-vermelha" width={110} height={110} className="absolute right-[-80px] bottom-8 rotate-[15deg]" />
          <div data-aos="fade-left" data-aos-duration="900">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreRosa} alt="torre-vermelha" width={110} height={110} className="absolute left-[-80px] top-5 rotate-[-15deg]" />
          <div data-aos="fade-right" data-aos-duration="900">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreRoxa} alt="torre-vermelha" width={110} height={110} className="absolute right-[-80px] top-[-30px] rotate-[15deg]" />
          <div data-aos="fade-left" data-aos-duration="900">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image src={TorreVerde} alt="torre-vermelha" width={110} height={110} className="absolute left-[-80px] top-[-30px] rotate-[-15deg]" />
          <div data-aos="fade-right" data-aos-duration="900">
      ...
      <div className="bg-[#E6E4D5] rounded-b-[80px] w-full h-[33em] flex flex-col gap-[80px] items-center justify-center p-[80px] z-10 text-xl">
        ...
        <div className="w-full h-full flex flex-col gap-[80px] justify-center items-center">
          <div className="w-fit h-fit flex flex-col gap-6" data-aos="fade-up" data-aos-duration="800">
            <div className="absolute z-20 left-[-20px] top-[-20px] rotate-[-40deg]">
              <Croissaint height={50} width={50} />
            </div>
            <div className="absolute right-[-20px] top-[-20px] rotate-[20deg] z-20">
              <French height={50} width={50} />
            </div>
            ...
            <div className="h-full flex flex-col justify-center items-center" data-aos="fade-up" data-aos-duration="1000">
