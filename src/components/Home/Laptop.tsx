...
export default function Laptop() {
  return(
    <div className="w-[100% - 80px] mx-auto h-auto flex justify-center flex-col items-center overflow-hidden">
      ...
      <div className="rounded-b-[80px] w-full h-[195em] flex flex-col gap-[80px] items-center justify-around p-[80px] z-10 text-xl">
      ...
      <div className="rounded-b-[80px] w-full h-[225em] flex flex-col gap-[80px] items-center justify-around p-[80px] z-10 text-xl">
      ...
      <div className="bg-[#E6E4D5] rounded-b-[80px] w-full h-[38em] flex flex-col gap-[80px] items-center justify-around p-[80px] z-10 text-xl">
