...
export default function Tablet() {
  return(
    <div className="w-[100% - 80px] mx-auto h-auto flex justify-center flex-col items-center overflow-hidden">
      ...
      <div className="relative rounded-b-[80px] w-full h-[218em] mt-12 flex flex-col items-center justify-between p-[80px] z-10 text-xl">
      ...
      <div className="bg-[#E6E4D5] rounded-b-[80px] w-full h-[40em] flex flex-col gap-[80px] items-center justify-center p-[80px] z-10 text-xl">
