export default function Eifell({ height=10, width=10, color='#000000' }: { height: number, width: number, color: string }) {
    return(
        <svg 
        height={height}
        width={width} 
