...
export default function Tablet() {
  return (
    <div className="w-[100% - 80px] mx-auto h-auto flex justify-center flex-col items-center overflow-hidden">
      <div className="w-full h-[180em] mt-8 flex flex-col items-center justify-between p-[80px] text-xl">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image
            ...
            width={180}
            height={180}
            className="absolute left-[-50px] bottom-8 rotate-[-15deg]"
          />
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image
            ...
            width={180}
            height={180}
            className="absolute right-[-50px] bottom-8 rotate-[15deg]"
          />
      ...
      <div className="relativ w-full h-[218em] mt-12 flex flex-col items-center justify-between p-[80px] text-xl">
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image
            ...
            width={180}
            height={180}
            className="absolute left-[-50px] top-5 rotate-[-15deg]"
          />
          <div data-aos="fade-right" data-aos-duration="900">
            <Image
              className="rounded-xl"
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image
            ...
            width={180}
            height={180}
            className="absolute right-[-50px] top-[-30px] rotate-[15deg]"
          />
          <div data-aos="fade-left" data-aos-duration="900">
            <Image
              className="rounded-xl"
        ...
        <div className="relative w-full flex flex-col gap-[80px] justify-center items-center">
          <Image
            ...
            width={180}
            height={180}
            className="absolute left-[-50px] top-[-30px] rotate-[-15deg]"
          />
          <div data-aos="fade-right" data-aos-duration="900">
            <Image
              className="rounded-xl"
