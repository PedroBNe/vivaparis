  ...
  return (
    <div className='w-full min-h-screen flex text-black'>
      <div className='w-full h-auto flex flex-col'>
        <div className='w-[70%] flex items-center justify-between gap-16'>
          <h1 className='font-bold text-3xl'>Category List</h1>
          <Link href={"/dashboard/category/new"}>
            <Button>Criar Categoria</Button>
          </Link>
        </div>
        <ul className='w-[68%] p-4 m-5 flex flex-col gap-2 justify-center items-center bg-white rounded-xl'>
